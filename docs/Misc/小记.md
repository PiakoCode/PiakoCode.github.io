...
[adw-gtk-theme](https://archlinux.org/packages/extra/any/adw-gtk-theme/)浅色主题问题：

dms默认adw-gtk-theme的浅色主题名为`adw-gtk3-light`

而archlinux下adw-gtk-theme浅色主题名和位置为`adw-gtk3`

解决方案:创建一个软链接

```
cd /usr/share/themes/
sudo ln -s adw-gtk3 adw-gtk3-light
```